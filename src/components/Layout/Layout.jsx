    ...
    return (
      <>
        ...
        <div className={layoutStyles.container} ref={containerRef}>
          ...
          <div className={`${layoutStyles.bgCircle} ${layoutStyles.parallaxLayer1} ${layoutStyles.circle2} ${layoutStyles.displayedOnMobile} ${layoutStyles.bgColorSkyBlueCrayola}`}></div>
